    ...
    return (
        <>
            <div className="bg-[url('/src/assets/hero-10.jpg')] bg-cover bg-center bg-no-repeat h-screen">
                <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 w-full h-screen bg-[rgba(255,255,255,0.2)] text-gray-900">
                    
                    <div className="mt-50">
                        <p className="md:text-2xl font-black text-center">Homes for Every Stage of Life</p>
                        <h1 className="md:text-5xl font-light mt-2 max-w-xl text-center">
